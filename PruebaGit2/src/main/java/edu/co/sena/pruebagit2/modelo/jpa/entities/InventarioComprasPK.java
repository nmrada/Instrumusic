 ...
 */
package edu.co.sena.pruebagit2.modelo.jpa.entities;
...
public class InventarioComprasPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.pruebagit2.modelo.jpa.entities.InventarioComprasPK[ idinventario=" + idinventario + ", productoIdProducto=" + productoIdProducto + ", proveedorTipoDocumentoTipoDocumento=" + proveedorTipoDocumentoTipoDocumento + ", proveedorNumDocumento=" + proveedorNumDocumento + " ]";
    }
