...
public class DomicilioCuenta implements Serializable {
    ...
    public String toString() {
        return "DomicilioCuenta{" + "tipoDocumentoCuenta=" + domicilioCuentaPK.getCuentatipoDocumento() + ", numeroDocumentoCuenta=" + domicilioCuentaPK.getCuentanumeroDocumento() +", telefono=" + telefono + ", direccion=" + direccion + ", barrio=" + barrio + ", localidad=" + localidad + ", municipioidMunicipio=" + municipioidMunicipio.getIdMunicipio() + '}';
    }
