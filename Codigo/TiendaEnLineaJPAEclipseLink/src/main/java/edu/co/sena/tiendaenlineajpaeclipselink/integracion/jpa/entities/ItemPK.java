...
public class ItemPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.tiendaenlineajpaeclipselink.integracion.jpa.entities.ItemPK[ productoidProducto=" + productoidProducto + ", pedidoFacturaidFactura=" + pedidoFacturaidFactura + " ]";
    }
