...
public class DomicilioProveedor implements Serializable {
    ...
    public String toString() {
        return "DomicilioProveedor{" + "idProveedor=" + domicilioProveedorPK.getProveedoridProveedor() + ", tipoIdentificacionProveedor=" + domicilioProveedorPK.getProveedortipoDeIdentificacion() + ", telefono=" + telefono + ", direccion=" + direccion + ", barrio=" + barrio + ", localidad=" + localidad + ", municipioidMunicipio=" + municipioidMunicipio.getIdMunicipio() + '}';
    }
