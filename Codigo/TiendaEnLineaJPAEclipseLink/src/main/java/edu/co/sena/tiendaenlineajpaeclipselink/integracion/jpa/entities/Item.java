...
public class Item implements Serializable {
    ...
    public String toString() {
        return "Item{" + "ProductoIdProducto=" + itemPK.getProductoidProducto() +", PedidoIdFactura=" + itemPK.getPedidoFacturaidFactura() + ", cantidad=" + cantidad + ", costoUnitario=" + costoUnitario + ", costoTotal=" + costoTotal + '}';
    }
