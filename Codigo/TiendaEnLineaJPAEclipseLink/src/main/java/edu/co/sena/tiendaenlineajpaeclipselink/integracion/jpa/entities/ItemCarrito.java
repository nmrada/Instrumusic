...
public class ItemCarrito implements Serializable {
    ...
    @JoinColumn(name = "CarritoDeCompras_idCarritoDeCompras", referencedColumnName = "idCarritoDeCompras", insertable = false, updatable = false)
    @ManyToOne(optional = false)
    ...
    public String toString() {
        return "ItemCarrito{" + "ProductoIdProducto=" + itemCarritoPK.getProductoidProducto() + ", CarritoDeComprasIdCarritoCompras=" + itemCarritoPK.getCarritoDeComprasidCarritoDeCompras() +", cantidad=" + cantidad + ", costoUnitario=" + costoUnitario + ", costoTotal=" + costoTotal + '}';
    }
