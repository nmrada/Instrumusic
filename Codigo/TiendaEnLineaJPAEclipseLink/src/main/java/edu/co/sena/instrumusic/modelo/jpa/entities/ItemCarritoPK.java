...
public class ItemCarritoPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.instrumusic.modelo.jpa.entities.ItemCarritoPK[ productoidProducto=" + productoidProducto + ", carritoDeComprasidCarritoDeCompras=" + carritoDeComprasidCarritoDeCompras + " ]";
    }
