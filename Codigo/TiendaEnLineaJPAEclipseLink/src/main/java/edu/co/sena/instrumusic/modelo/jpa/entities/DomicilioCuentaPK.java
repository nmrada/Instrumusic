...
public class DomicilioCuentaPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.instrumusic.modelo.jpa.entities.DomicilioCuentaPK[ cuentaTipoDocumentotipoDocumento=" + cuentaTipoDocumentotipoDocumento + ", cuentanumeroDocumento=" + cuentanumeroDocumento + " ]";
    }
