...
public class Inventario implements Serializable {
    ...
    public String toString() {
        return "Inventario{" + "idInventario=" + inventarioPK.getIdInventario() + ", idProducto=" + inventarioPK.getProductoidProducto() + ", ProveedorIdProveedor=" + inventarioPK.getProveedoridProveedor() + ", ProveedorTipoIdentificacion=" + inventarioPK.getProveedortipoDeIdentificacion() + ", fecha=" + fecha + ", cantidad=" + cantidad + '}';
    }
