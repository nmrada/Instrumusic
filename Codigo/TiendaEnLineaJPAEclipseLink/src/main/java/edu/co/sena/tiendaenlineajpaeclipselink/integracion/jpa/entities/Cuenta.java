...
public class Cuenta implements Serializable {
    ...
    public String toString() {
        return "Cuenta{" + "tipoDocumento=" + cuentaPK.getTipoDocumento() + ", numeroDocumento=" + cuentaPK.getNumeroDocumento() + ", primerNombre=" + primerNombre + ", segundoNombre=" + segundoNombre + ", primerApellido=" + primerApellido + ", segundoApellido=" + segundoApellido +", usuarioidUsuario=" + usuarioidUsuario.getIdUsuario() +'}';
    }
