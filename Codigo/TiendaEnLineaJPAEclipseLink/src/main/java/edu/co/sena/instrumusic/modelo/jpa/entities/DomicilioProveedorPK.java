...
public class DomicilioProveedorPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.instrumusic.modelo.jpa.entities.DomicilioProveedorPK[ proveedorTipoDocumentotipoDocumento=" + proveedorTipoDocumentotipoDocumento + ", proveedornumeroDocumento=" + proveedornumeroDocumento + " ]";
    }
