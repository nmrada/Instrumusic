...
public class InventarioPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.instrumusic.modelo.jpa.entities.InventarioPK[ idInventario=" + idInventario + ", productoidProducto=" + productoidProducto + ", proveedorTipoDocumentotipoDocumento=" + proveedorTipoDocumentotipoDocumento + ", proveedornumeroDocumento=" + proveedornumeroDocumento + " ]";
    }
