 ...
 */
package edu.co.sena.pruebagit.modelo.jpa.entities;
...
public class InventarioComprasPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.pruebagit.pruebagit.InventarioComprasPK[ idinventario=" + idinventario + ", productoIdProducto=" + productoIdProducto + ", proveedorTipoDocumentoTipoDocumento=" + proveedorTipoDocumentoTipoDocumento + ", proveedorNumDocumento=" + proveedorNumDocumento + " ]";
    }
